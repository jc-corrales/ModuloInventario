sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.maestroDetalle.controller.VistaCategoriaDeProductos", {
		...
		onInit: function () {
			...
			this.oRouter.getTarget("VistaCategoriaDeProductos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1-6kplpgnmgbd62tvvfh2dgpyx9_S9-57v0anue1jqk85uiwg0hu6l016_S16",
				"groups": ["items"]
			}];
